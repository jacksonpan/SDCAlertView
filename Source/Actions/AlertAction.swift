...
public class AlertAction: NSObject {
    ...
    @objc
    public convenience init(title: String?, style: AlertAction.Style, ac: AlertController,  handler: ((AlertAction) -> Void)? = nil) {
        self.init()
        self.title = title
        self.style = style
    ...
    @objc
    public convenience init(attributedTitle: NSAttributedString?, style: AlertAction.Style, ac: AlertController, handler: ((AlertAction) -> Void)? = nil)
    {
        self.init()
